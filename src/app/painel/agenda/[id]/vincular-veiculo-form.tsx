 ...
 * sempre rolava até o card de verdade. Vira modal só quando há uma escolha
 * real a fazer (algum veículo já cadastrado) — sem nenhum veículo, o modal
 * só serviria pra mandar pra outro lugar, então nesse caso o botão já
 * navega direto pra lá, sem passo extra.
 */
export function VincularVeiculoButton({
  ...
  if (veiculos.length === 0) {
    return (
      <Link href={`/painel/clientes/${clienteId}`} className={botaoClasse}>
