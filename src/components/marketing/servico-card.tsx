...
export function ServicoCard({
  ...
  return (
    ...
    >
      <Card className="h-full gap-0 rounded-md border border-neutral-200 py-0 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-brand/40 hover:shadow-md">
